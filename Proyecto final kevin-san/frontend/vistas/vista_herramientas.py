...
class VistaHerramientas(Frame):
    ...
    def crear_herramienta(self):
        ...
        self.lista_herramientas.append(nueva)
    ...
    def editar_herramienta(self):
        ...
        herramienta = self.lista_herramientas[self.fila_seleccionada]

        herramienta["nombre"] = self.nombre_var.get()
        herramienta["categoria"] = self.categoria_var.get()
        herramienta["ubicacion"] = self.ubicacion_var.get()
        herramienta["estado"] = self.estado_var.get()
    ...
    def eliminar_herramienta(self):
        ...
        del self.lista_herramientas[self.fila_seleccionada]
        self.actualizar_tabla()
        self.limpiar_formulario()
        self.fila_seleccionada = None
